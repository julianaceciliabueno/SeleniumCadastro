...
browser.get('https://qa.clude.com.br/cluder/Login/Index2?ReturnUrl=%2fcluder')
...
class Test_logindiario():
    ...
    def test_pessoal(self):
        ...
        self.driver.find_element(By.NAME, "email").send_keys('87654321@uorak.com')
...
class Test_Terceira_Parte():
    ...
    def test_pessoal(self):
        ...
        try:
            WebDriverWait(self.driver, 20).until(
                EC.element_to_be_clickable((By.XPATH, "(//div[contains(.,'09:00')])[12]"))).click()
            print("foi escolhido o horário 09:00")

        except TimeoutException:
            WebDriverWait(self.driver, 20).until(
                EC.element_to_be_clickable((By.XPATH, "(//div[contains(.,'14:00')])[12]"))).click()
            print("foi escolhido o horário 14:00")
